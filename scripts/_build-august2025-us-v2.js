#!/usr/bin/env node
/** Build meta.json + questions.json for 2025-august-us-v2 from module drafts. */
const fs = require("fs");
const path = require("path");

const DIR = path.join(__dirname, "..", "prisma", "data", "2025-august-us-v2");
...
const meta = {
  ...
  modules: {
    ENGLISH: {
      ...
      "2": {
        timeLimit: 1920,
        pageByQuestion: pageMap(rw2, (o) => 20 + o),
    ...
    MATH: {
      "1": {
        timeLimit: 2100,
        pageByQuestion: pageMap(m1, (o) => 42 + o),
        answers: answersFrom(m1),
      },
      "2": {
        timeLimit: 2100,
        pageByQuestion: pageMap(m2, (o) => 60 + o),
