...
const DATA_DIR = path.join(__dirname, "data", "2025-june-us-b");
...
async function main() {
  ...
  console.log("Seeding 2025 June US-B (ENGLISH + MATH)...");
  ...
  console.log("Card: 2025 → 2025 June Digital → US Form B");
}
