...
const DATA_DIR = path.join(__dirname, "data", "2025-march-us-a");
...
async function main() {
  ...
  console.log("Seeding 2025 March US-A (ENGLISH + MATH)...");
  ...
  console.log("Card: 2025 → 2025 March Digital → US Form A");
}
