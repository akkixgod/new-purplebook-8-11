...
const DATA_DIR = path.join(__dirname, "data", "2025-june-int-a");
...
async function main() {
  ...
  console.log("Seeding 2025 June Int-A (ENGLISH from PDF; Math absent in source)...");
  ...
  // Do not create empty MATH placeholder — UI-confusing empty tests are disallowed.
  if (meta.modules.MATH) {
    await seedSection("MATH", meta.modules.MATH, questions.MATH ?? {}, meta);
  } else {
    console.log("Skipping MATH — not present in 2025 June Int-A PDF / answer key.");
  }
