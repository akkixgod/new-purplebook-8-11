...
const DATA_DIR = path.join(__dirname, "data", "2025-august-us-v3");
...
async function main() {
  ...
  console.log("Seeding 2025 August US V3 (exact text + figures)...");
  ...
  console.log("Card: 2025 → 2025 August Digital → US Form V3");
}
