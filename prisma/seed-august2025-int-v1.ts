...
const DATA_DIR = path.join(__dirname, "data", "2025-august-int-v1");
...
async function main() {
  ...
  console.log("Seeding 2025 August INT V1 (exact text + figures)...");
  ...
  console.log("Card: 2025 → 2025 August Digital → International Form V1");
}
