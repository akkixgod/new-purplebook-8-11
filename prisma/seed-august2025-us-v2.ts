...
const DATA_DIR = path.join(__dirname, "data", "2025-august-us-v2");
...
async function main() {
  ...
  console.log("Seeding 2025 August US V2 (exact text + figures)...");
  ...
  console.log("Card: 2025 → 2025 August Digital → US Form V2");
}
