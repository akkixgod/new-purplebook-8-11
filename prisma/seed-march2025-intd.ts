...
const DATA_DIR = path.join(__dirname, "data", "2025-march-int-d");
...
async function main() {
  ...
  console.log("Seeding 2025 March Int-D (ENGLISH + MATH)...");
  ...
  console.log("Card: 2025 → 2025 March Digital → International Form D");
}
